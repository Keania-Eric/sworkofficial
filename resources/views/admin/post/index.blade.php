                            ...
                            <div class="row" v-if="showCategoriesFilter">
                                ...
                                <div class="col col-lg-12 col-xl-12 form-group">
                                    <multiselect v-model="categoriesMultiselect"
                                        ...
                                        label="label"
                                        track-by="key"
                                        placeholder="{{ __('Type to search a category') }}"
                                        :limit="2"
                                        :multiple="true">
                                    </multiselect>
                                </div>
                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'image'">{{ trans('admin.post.columns.image') }}</th>
                                        <th is='sortable' :column="'featured'">{{ trans('admin.post.columns.featured') }}</th>
                                        <th is='sortable' :column="'post_category_id'">{{ trans('admin.post.columns.post_category_id') }}</th>
                                        <th is='sortable' :column="'author'">{{ trans('admin.post.columns.author') }}</th>
                                        <th is='sortable' :column="'intro_text'">{{ trans('admin.post.columns.intro_text') }}</th>
                                    ...
                                    <td>@{{ item.id }}</td>
                                        ...
                                        <td>
                                            <label class="switch switch-3d switch-success">
                                                <input type="checkbox" class="switch-input" v-model="collection[index].featured" @change="toggleSwitch(item.resource_url, 'featured', collection[index])">
