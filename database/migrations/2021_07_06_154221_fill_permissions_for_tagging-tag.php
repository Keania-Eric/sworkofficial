...
class FillPermissionsForTaggingTag extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTaggingTag constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tagging-tag',
            'admin.tagging-tag.index',
            'admin.tagging-tag.create',
            'admin.tagging-tag.show',
            'admin.tagging-tag.edit',
            'admin.tagging-tag.delete',
            'admin.tagging-tag.bulk-delete',
        ]);
