...
class FillPermissionsForNavItem extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForNavItem constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.nav-item',
            'admin.nav-item.index',
            'admin.nav-item.create',
            'admin.nav-item.show',
            'admin.nav-item.edit',
            'admin.nav-item.delete',
            'admin.nav-item.bulk-delete',
        ]);
