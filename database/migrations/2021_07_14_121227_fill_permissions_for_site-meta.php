...
class FillPermissionsForSiteMeta extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSiteMeta constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.site-meta',
            'admin.site-meta.index',
            'admin.site-meta.create',
            'admin.site-meta.show',
            'admin.site-meta.edit',
            'admin.site-meta.delete',
            'admin.site-meta.bulk-delete',
        ]);
