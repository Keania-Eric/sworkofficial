...
class FillPermissionsForSiteImage extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSiteImage constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.site-image',
            'admin.site-image.index',
            'admin.site-image.create',
            'admin.site-image.show',
            'admin.site-image.edit',
            'admin.site-image.delete',
            'admin.site-image.bulk-delete',
        ]);
